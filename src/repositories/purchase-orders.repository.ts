...
import {AccountPayable, AccountsReceivable, Collection, Container, DeliveryRequest, Proforma, Project, PurchaseOrders, PurchaseOrdersRelations, QuotationProducts, Provider, Quotation, Document} from '../models';
...
> {
  ...
  public readonly document: HasOneRepositoryFactory<Document, typeof PurchaseOrders.prototype.id>;
